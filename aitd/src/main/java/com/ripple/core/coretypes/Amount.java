...
import com.ripple.core.coretypes.uint.UInt128;
 ...
 */
public class Amount extends Number implements SerializedType, Comparable<com.ripple.core.coretypes.Amount> {
...
//    public static final Amount NEUTRAL_ZERO = new Amount(Currency.NEUTRAL, AccountID.NEUTRAL);
    ...
    public static class PrecisionError extends RuntimeException {
        public com.ripple.core.coretypes.Amount illegal;

        public PrecisionError(String s) {
            super(s);
        }

        public PrecisionError(String s, com.ripple.core.coretypes.Amount amount) {
            super(s);
            illegal = amount;
        }
    }
    ...
    public static final int MAXIMUM_IOU_PRECISION = 24;
    ...
    public static final com.ripple.core.coretypes.Amount ONE_XRP = fromString("1.0");
    ...
    private UInt128 mantissa = null;
    private UInt64 mantissa64 = null;
    ...
    private com.ripple.core.coretypes.Amount newValue(BigDecimal newValue) {
        return newValue(newValue, false, false);
    }

    private com.ripple.core.coretypes.Amount newValue(BigDecimal newValue, boolean round, boolean unbounded) {
        if (round) {
    ...
    private com.ripple.core.coretypes.Amount newValue(BigDecimal val, boolean round) {
    ...
    public UInt64 mantissa64() {
        if (mantissa64 == null) {
            mantissa64 = calculateMantissa64();
        }
        return mantissa64;
    }
     ...
     */
    private UInt128 calculateMantissa() {
        if (isNative()) {
            return new UInt128(bigIntegerDrops().abs());
        } else {
            return new UInt128(bigIntegerIOUMantissa());
        }
    }

    private UInt64 calculateMantissa64() {
        if (isNative()) {
    ...
    private boolean equalValue(com.ripple.core.coretypes.Amount amt) {
        return compareTo(amt) == 0;
    }

    @Override
    public boolean equals(Object obj) {
        if (obj instanceof com.ripple.core.coretypes.Amount) {
            return equals((com.ripple.core.coretypes.Amount) obj);
        }
        return super.equals(obj);
    }

    public boolean equals(com.ripple.core.coretypes.Amount amt) {
        return equalValue(amt) &&
                currency.equals(amt.currency) &&
                (isNative() || issuer.equals(amt.issuer));
    }

    public boolean equalsExceptIssuer(com.ripple.core.coretypes.Amount amt) {
        return equalValue(amt) &&
                currencyString().equals(amt.currencyString());
    }


    public int compareTo(com.ripple.core.coretypes.Amount amount) {
     ...
     */
    public com.ripple.core.coretypes.Amount add(BigDecimal augend) {
        return newValue(value.add(augend), true);
    }

    public com.ripple.core.coretypes.Amount add(com.ripple.core.coretypes.Amount augend) {
        return add(augend.value);
    }

    public com.ripple.core.coretypes.Amount add(Number augend) {
        return add(BigDecimal.valueOf(augend.doubleValue()));
    }

    public com.ripple.core.coretypes.Amount subtract(BigDecimal subtrahend) {
        return newValue(value.subtract(subtrahend), true);
    }

    public com.ripple.core.coretypes.Amount subtract(com.ripple.core.coretypes.Amount subtrahend) {
        return subtract(subtrahend.value);
    }

    public com.ripple.core.coretypes.Amount subtract(Number subtrahend) {
        return subtract(BigDecimal.valueOf(subtrahend.doubleValue()));
    }

    public com.ripple.core.coretypes.Amount multiply(BigDecimal divisor) {
        return newValue(value.multiply(divisor, MATH_CONTEXT), true);
    }

    public com.ripple.core.coretypes.Amount multiply(com.ripple.core.coretypes.Amount multiplicand) {
        return multiply(multiplicand.value);
    }

    public com.ripple.core.coretypes.Amount multiply(Number multiplicand) {
        return multiply(BigDecimal.valueOf(multiplicand.doubleValue()));
    }

    public com.ripple.core.coretypes.Amount divide(BigDecimal divisor) {
        return newValue(value.divide(divisor, MATH_CONTEXT), true);
    }

    public com.ripple.core.coretypes.Amount divide(com.ripple.core.coretypes.Amount divisor) {
        return divide(divisor.value);
    }

    public com.ripple.core.coretypes.Amount divide(Number divisor) {
        return divide(BigDecimal.valueOf(divisor.doubleValue()));
    }

    public com.ripple.core.coretypes.Amount negate() {
        return newValue(value.negate());
    }

    public com.ripple.core.coretypes.Amount abs() {
        return newValue(value.abs());
    }

    public com.ripple.core.coretypes.Amount min(com.ripple.core.coretypes.Amount val) {
        return (compareTo(val) <= 0 ? this : val);
    }

    public com.ripple.core.coretypes.Amount max(com.ripple.core.coretypes.Amount val) {
        return (compareTo(val) >= 0 ? this : val);
    }

    /* Offer related helpers */
    public BigDecimal computeQuality(com.ripple.core.coretypes.Amount toExchangeThisWith) {
     ...
     * just `one`.
     */
    public com.ripple.core.coretypes.Amount one() {
        if (isNative()) {
            return ONE_XRP;
        } else {
    ...
    public void toBytesSink(BytesSink to) {
        if (!Config.getB58().isXrp()) {
            UInt128 man = mantissa();
            byte[] manBytes = man.toByteArray();

            if (isNative()) {
                manBytes[0] |= !isNegative() ? 0x40 : 0;
                to.add(manBytes);
            } else {
                manBytes[0] |= 0x80;
                if (!this.isZero()) {
                    ...
                    manBytes[0] |= exponentByte >>> 2;
                    manBytes[1] |= (exponentByte & 0x03) << 6;
                }
                to.add(manBytes);
            ...
            if (isNative()) {
                ...
                if (isZero()) {
                    ...
                    packed = man.or(new UInt128(512 + 97 + exponent).shiftLeft(64 - 10));
                } else {
                    packed = man.or(new UInt128(512 + 256 + 97 + exponent).shiftLeft(64 - 10));
                }
    ...
    public static class Translator extends TypeTranslator<com.ripple.core.coretypes.Amount> {
        @Override
        public com.ripple.core.coretypes.Amount fromString(String s) {
        ...
        @Override
        public com.ripple.core.coretypes.Amount fromParser(BinaryParser parser, Integer hint) {
            BigDecimal value;
            byte[] mantissa = parser.read(!Config.getB58().isXrp() ? 16 : 8);
        ...
        @Override
        public JSONObject toJSONObject(com.ripple.core.coretypes.Amount obj) {
            return obj.toJSONObject();
        }

        @Override
        public com.ripple.core.coretypes.Amount fromJSONObject(JSONObject jsonObject) {
            String valueString = null;
            try {
                valueString = jsonObject.getString("value");
            } catch (JSONException e) {
                e.printStackTrace();
            }
            String issuerString = null;
            try {
                issuerString = jsonObject.getString("issuer");
            } catch (JSONException e) {
                e.printStackTrace();
            }
    ...
    public com.ripple.core.coretypes.Amount newIssuer(AccountID issuer) {
        return new Amount(value, currency, issuer);
    }

    public com.ripple.core.coretypes.Amount copy() {
        return new Amount(value, currency, issuer, isNative, unbounded);
    }

    // Static constructors
    public static com.ripple.core.coretypes.Amount fromString(String val) {
        if (val.contains("/")) {
    ...
    public static com.ripple.core.coretypes.Amount fromDropString(String val) {
        BigDecimal drops = new BigDecimal(val).scaleByPowerOfTen(-6);
        checkDropsValueWhole(val);
        return new Amount(drops);
    }

    public static com.ripple.core.coretypes.Amount fromIOUString(String val) {
    ...
    @Deprecated
    private static com.ripple.core.coretypes.Amount fromXrpString(String valueString) {
    ...
    public String nativeText() {
        return String.format("%s/AITD", valueText());
    }
